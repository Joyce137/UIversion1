...
import com.liwei.uiversion1.bean.Doctor;
...
public class DoctorList extends Activity implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent i = new Intent();
		i.setComponent(new ComponentName("com.liwei.uiversion1",
				"com.liwei.uiversion1.DoctorSessionAty"));
